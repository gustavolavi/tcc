...
public class EmployeeApiController {
	...
	public ResponseEntity<?> create(UriComponentsBuilder uriComponentsBuilder,@RequestBody Employee employee) {
	...
	public ResponseEntity<?> update(UriComponentsBuilder uriComponentsBuilder,@PathVariable int id,@RequestBody Employee employee) {
		employee.setId(id);
